...
//		imprimirSelecionados();
		String[] candidatos = { "GEI", "PAULO", "JAIRO", "EMÍLIA", "MOISÉS" };
	...
	static void entrarEmContato(String candidato) {
		...
		if (atendeu)
			...
			System.out.println("NÃO CONSEGUIMOS CONTATO COM " + candidato + ", NÚMERO MÁXIMO DE TENTATIVAS  "
					+ tentativasRealizadas + " REALIZADA(S)");
	}
	...
	static void imprimirSelecionados() {
		...
		System.out.println("Usando forEach para iterar a lista");
	...
	static void selecaoCandidato() {
		String[] candidatos = { "GEI", "PAULO", "JAIRO", "EMÍLIA", "MOISÉS", "BÁRBARA", "LUIZA", "LUNA", "VINÍCIUS",
				"GEISINHA" };
